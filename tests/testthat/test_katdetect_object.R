...
testthat::test_that("test KatDetect object:", {
    ...
    testthat::expect_equal(katdetectr::getGenomicVariants(kd)$IMD[1], base::as.numeric(NA))
    testthat::expect_equal(katdetectr::getKataegisFoci(kd)$meanIMD[1], 434.16667)
